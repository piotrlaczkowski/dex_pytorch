...
def fetch_model(model_data):
    ...
    if model_data.startswith("file"):
        ...
        shutil.copy2(os.path.join(model_dir, "model.tar.gz"), os.path.join(model_dir, "model.tar.gz"))
...
if __name__ == "__main__":
    model_data = (
        "s3://sagemaker-us-west-2-688520471316/mxnet/mnist/pytorch-training-2020-11-21-22-02-56-203/model.tar.gz"
    )
    test(model_data)
